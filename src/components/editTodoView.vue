      ...
      <form class="">
        ...
        <div class="">
          <div class="input-field">
            <input placeholder="输入标题" id="todoTitle" type="text"  v-model="curEditTodo.todoTitle"
          ...
          <div class="input-field ">
            <textarea placeholder="输入描述" id="describe" class="materialize-textarea" v-model="curEditTodo.todoDescribe"
